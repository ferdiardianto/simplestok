...
$(document).ready(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        datatype: 'local',
        pager: "#jqGridPager",
        caption: "List Data Barang Keluar",
 ...
 function fetchGridData(cabang) {
    ...
    $.ajax({
        url: base_url+'barangkeluar/getall',
        data: postvar,
...
function do_save(){
    ...
    if(txtkdbarang!=""){
        ...
        if(start=='save'){
            $.ajax({ 
                type: 'POST', 
                url: base_url+'barangkeluar/save', 
                data: postvars,  
                statusCode: {
            ...
            $.ajax({ 
                type: 'POST', 
                url: base_url+'barangkeluar/update', 
                data: postvars,  
                statusCode: {
                  200: function (response) {
                     //jika sukses
...
function caribarang(value){
  ...
  $.ajax({ 
      type: 'POST', 
      url: base_url+'barangkeluar/findbarang', 
      data: postvars,  
      dataType: "json",
      statusCode: {
        200: function (response) {
