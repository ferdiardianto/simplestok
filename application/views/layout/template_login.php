...
<html lang="en">
  <head>
    ...
    <title>Login SImple Stok</title>

    <!-- Bootstrap core CSS -->
    <link href="<?php echo config_item('assets');?>css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?php echo config_item('assets');?>css/signin.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="#">
        <h2 class="form-signin-heading">Masuk Simple Stok</h2>
      ...
      -->
        <button class="btn btn-lg btn-primary btn-block" type="none" onclick='ceklogin()'>Sign in</button>
      </form>
    ...
    <script src="<?php echo config_item('assets');?>js/login.js"></script>
  </body>
</html>
