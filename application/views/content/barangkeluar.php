...
<script src="<?php echo config_item('assets');?>js/barangkeluar.js"></script>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          -->
          <input type="hidden" class="form-control" id="txtautoincremen">

          <!-- drop doown kode barang -->
          <label for="txtkdbarang" class="control-label">Kode Barang:</label>
          <select class="form-control" id="txtkdbarang" onchange='caribarang(this.value)'>
          ...
          <input type="hidden" class="form-control" id="txtnamabarang" readonly>
        </div>
        ...
        <div class="form-group" id='fieldjumlah'>
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control" id="txtharga" onblur='konversiangka(3)' readonly>
        </div>
      </form>
